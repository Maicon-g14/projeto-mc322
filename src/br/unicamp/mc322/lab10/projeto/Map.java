...
import br.unicamp.mc322.lab10.projeto.map.objects.objects.inventoryitems.equipment.StartEquipment;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.forniture.types.Chest;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.forniture.types.Trap;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.structure.types.Door;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.structure.types.HiddenDoor;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.structure.types.Stair;
import br.unicamp.mc322.lab10.projeto.map.objects.objects.mapitems.structure.types.Wall;
...
public class Map {
	...
	public boolean isEmptyPosition(Coordinate position, GameTypeObjects type) {
		...
		return (isValid(position) && (getPosition(position) == null || (getPosition(position).getId() == GameTypeObjects.TRAP && type == GameTypeObjects.HERO)));
	}

...
public enum ArmorClasses {
	...
	public static boolean isEquipable(GameTypeObjects person, ArmorClasses itemClass) {
		...
		return ((person == GameTypeObjects.ELF || person == GameTypeObjects.DWARF) && itemClass == LIGHT_ARMOR)
				|| (person == GameTypeObjects.DWARF && itemClass == SHIELD)
				|| (person == GameTypeObjects.BARBARIAN);

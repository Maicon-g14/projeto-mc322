...
public class BetterLongSword extends Attack{
	...
	private final String NAME = "Better Long Sword";
	private final int ATTACK = 1;
	private final int DICE_NUMBER = 1;
	private final boolean BREAKABLE = false;
	private final int REACH = 1;
	private final WeaponsTypes WEAPON_CLASS = WeaponsTypes.LONG_SWORD;
